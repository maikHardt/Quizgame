...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 30. Jun 2024 um 19:54
...
INSERT INTO `punkte` (`PuNr`, `PuPunkte`, `PuDate`, `PuSpNr`) VALUES
(1, 25, '2024-06-30 00:00:00', 1),
(2, 5, '2024-06-30 00:00:00', 2),
(3, 25, '2024-06-30 00:00:00', 6),
(4, 5, '2024-06-30 00:00:00', 8);
...
INSERT INTO `spieler` (`SpNr`, `SpName`) VALUES
(1, 'Maik'),
(2, 'Jello'),
(3, 'Tobi'),
(4, 'Eli'),
...
--
ALTER TABLE `punkte`
  MODIFY `PuNr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT für Tabelle `spieler`
--
ALTER TABLE `spieler`
  MODIFY `SpNr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
